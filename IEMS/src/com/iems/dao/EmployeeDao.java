...
public void saveedu(Object obj) {
	...
	public List<?> mapSQLQuery(String queryString)
	{
	   ...
	   public int addEducation(int eid, int columnid,String degree){
		   
		   SQLQuery query = session.createSQLQuery("insert into education (id,eid,columnid,degree) values (0"+","+eid+","+columnid+",'"+degree+"');");
		   int res=query.executeUpdate();
		   session.close();
	   return res;
	   }
